...
Container.prototype._resolveModuleCreator = function(path) {
    ...
    var fn, thisArg;
    if(typeof moduleContent === 'object' && (!moduleContent.hasOwnProperty('default') && typeof moduleContent.default !== 'function')) {
        ...
        fn = moduleContent;
    } else if(moduleContent.hasOwnProperty('default') && typeof moduleContent.default === 'function') {
        fn = moduleContent.default;
    }
    else {
...
//parseable by: http://bl.ocks.org/mbostock/1153292
Container.prototype.createDependencyChart = function() {
    var links = [];
    _.each(this.dependencies, function(dependencies, name) {
        _.each(dependencies.requestedDependencies,function(dependency) {
